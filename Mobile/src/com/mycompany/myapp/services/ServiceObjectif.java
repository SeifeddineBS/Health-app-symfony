...
public class ServiceObjectif {
    ...
    public ArrayList<Objectif> getAllObjectifs() {
        String url = Statics.BASE_URL + "mesObjectifs";
        req.setUrl(url);
        req.setPost(false);
    ...
    public boolean addObjectif(Objectif t) {
        String url = Statics.BASE_URL + "ajouterObjectif?description=" + t.getDescription() + "&reponse=" + t.getReponse() + "&dateDebut=" + t.getDate() + "&duree=" + t.getDuree();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public boolean modifierObjectif(Objectif t) {
        String url = Statics.BASE_URL + "modifierObjectif/" + t.getId() + "?description=" + t.getDescription() + "&reponse=" + t.getReponse() + "&dateDebut=" + t.getDate() + "&duree=" + t.getDuree();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public boolean SupprimerObjectif(Objectif t) {
        String url = Statics.BASE_URL + "supprimerObjectif/" + t.getId();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {

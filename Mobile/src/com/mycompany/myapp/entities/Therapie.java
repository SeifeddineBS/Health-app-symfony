...
public class Therapie {
    ...
    public Therapie(int id, int nombremax, int nombre_parti, String sujet, String date, String lieu) {
        this.id = id;
    ...
    public String toString() {
        return "Therapie{" + "id=" + id + ", nombremax=" + nombremax + ", nombre_parti=" + nombre_parti + ", sujet=" + sujet + ", date=" + date + ", lieu=" + lieu + ", idcoach=" +  + '}';
    }

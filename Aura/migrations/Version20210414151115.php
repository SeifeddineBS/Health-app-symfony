 ...
 */
final class Version20210414151115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objectif ADD updated_at DATETIME NOT NULL, CHANGE dateDebut dateDebut VARCHAR(50) NOT NULL, CHANGE idClient idClient VARCHAR(255) DEFAULT NULL, CHANGE mailchecked mailchecked INT NOT NULL, CHANGE icone icone VARCHAR(50) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objectif DROP updated_at, CHANGE dateDebut dateDebut DATE NOT NULL, CHANGE mailchecked mailchecked INT DEFAULT NULL, CHANGE icone icone VARCHAR(50) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, CHANGE image image VARCHAR(60) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, CHANGE idClient idClient VARCHAR(50) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`');

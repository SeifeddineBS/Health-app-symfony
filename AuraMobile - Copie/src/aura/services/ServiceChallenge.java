...
public class ServiceChallenge {
    ...
    public static ServiceChallenge getInstance(){
     ...
     public ArrayList<challenge> getChallenges(){
      ...
      public ArrayList<challenge> getMesChallenges(){
         
         

         String url =statics.BASE_URL+"/MesChallengesMobile";
         ConnectionRequest request = new ConnectionRequest(url);
         request.setPost(false);
         request.getResponseContentType();
         System.out.println("********************************");
      ...
      public boolean rejoindreChallenges(int id ,String client){
         ...
         String url =statics.BASE_URL+"/rejoindreChallengeMobile/"+id;
         ConnectionRequest request = new ConnectionRequest(url);
         request.setPost(false);
         request.getResponseContentType();
         System.out.println("********************************");
    ...
    //finirChallenges
       ...
       public boolean finirChallenges(challenge c,String client){
         ...
         String url =statics.BASE_URL+"/JsonfinirChallenge/"+c.getId();
         ConnectionRequest request = new ConnectionRequest(url);
         request.setPost(false);
         request.getResponseContentType();
         System.out.println("********************************");
